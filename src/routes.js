...
const routes = [
  ...
  { path: '/voiture/Attente', name: 'Attente', element: Colors },
  { path: '/voiture/detail/:id', name: 'DetailsVoiture', element: DetailsVoiture},
  { path: '/voiture/Historique', name: 'Historique', element: Historique},
  { path: '/voiture/Categorie', name: 'Categorie', element: Categorie},
  { path: '/voiture/Model', name: 'Model', element: Model},
  { path: '/voiture/Marque', name: 'Marque', element: Marque},
